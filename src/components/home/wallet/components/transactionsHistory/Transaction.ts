...
import {
    ...
    BK_EARNED_TX_FEES, BK_PAID_BLOCK_FEES, BK_PAID_TX_FEES,
    BK_PLUS, BK_PURCHASE, BK_RECEIVED_ISSUANCE, BK_RECEIVED_PAYMENT, BK_SALE, BK_SENT_ISSUANCE, BK_SENT_PAYMENT,
    ChainReference,
    CMTSToken,
    Hash,
    Height
} from "@cmts-dev/carmentis-sdk-core";
import {AccountHistoryDto} from "../../../../../api/indexer/model";


export class Transaction {
    constructor(
        private readonly transaction: AccountHistoryDto
    ) {}
    ...
    public getLinkedAccount() {
        return this.transaction.linkedAccountId;
    }
