            ...
            <div class="space-y-6 py-2 pr-1">
                <div>
                    ...
                    <p class="text-sm text-surface-600 leading-relaxed">
                        Carmentis Desk is a desktop application that lets you manage your identity and assets on the
                        Carmentis blockchain network. It acts as a self-custodial wallet — you hold your own keys, no
                        third party ever has access to your funds or credentials.
                    </p>
                </div>
